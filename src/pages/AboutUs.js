  ...
  return (
    ...
    <div className="prod">
      <div className="mission" id="mission">
        <h1>Our Mission</h1>
        <p>Hydratech was established in Kenya in 2021 as a business Information and credit management company. In 2022 Hydratech entered into the business space of providing credit rating services that enable corporates to raise capital and meet their financing needs.</p>
        ...
        <p>We support Credit providers and the youth in by displaying their talents to the world for people to appreciate their work therefore advertising their work hence can lead for new oppertunities since they are able to get new clients from the web.You will also be able to edit your when necessary and post the new work</p>
      </div>
